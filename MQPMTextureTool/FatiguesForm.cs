...
namespace MQPMTextureTool
{
    public partial class FatiguesForm : Form
    {
        ...
        {
            Camo parasitePants = new Camo();
            parasitePants.name = "parasitePants";
            parasitePants.display = "Pants (Infected)";
            camos.Add(parasitePants);

            Camo skin1Pants = new Camo();
            skin1Pants.name = "skin1Pants";
            skin1Pants.display = "Pants (Cured #1)";
            camos.Add(skin1Pants);

            Camo skin2Pants = new Camo();
            skin2Pants.name = "skin2Pants";
            skin2Pants.display = "Pants (Cured #2)";
            camos.Add(skin2Pants);

            Camo skin3Pants = new Camo();
            skin3Pants.name = "skin3Pants";
            skin3Pants.display = "Pants (Cured #3)";
            camos.Add(skin3Pants);

            Camo skin4Pants = new Camo();
            skin4Pants.name = "skin4Pants";
            skin4Pants.display = "Pants (Cured #4)";
            camos.Add(skin4Pants);

            Camo skin5Pants = new Camo();
            skin5Pants.name = "skin5Pants";
            skin5Pants.display = "Pants (Cured #5)";
            camos.Add(skin5Pants);

            Camo skin1 = new Camo();
            skin1.name = "skin1";
            skin1.display = "Cured #1";
            camos.Add(skin1);

            Camo skin2 = new Camo();
            skin2.name = "skin2";
            skin2.display = "Cured #2";
            camos.Add(skin2);

            Camo skin3 = new Camo();
            skin3.name = "skin3";
            skin3.display = "Cured #3";
            camos.Add(skin3);

            Camo skin4 = new Camo();
            skin4.name = "skin4";
            skin4.display = "Cured #4";
            camos.Add(skin4);

            Camo skin5 = new Camo();
            skin5.name = "skin5";
            skin5.display = "Cured #5";
            camos.Add(skin5);
